        ...
        <v-navigation-drawer
          ...
          <v-row class="mx-0 px-3">
            <div class="appLauncherList">
              <div v-for="(application, index) in favoriteApplicationsList" class="appLauncherItem">
                <a target="_blank" :href="application.appUrl">
                  <img
                    v-if="application.appImageFileBody != undefined && application.appImageFileBody != ''"
                    class="appLauncherImage"
                    :src="application.appImageFileBody">
          ...
          <v-row class="seeAllApplications mx-0">
            <v-card
              ...
              <a
                ...
                href="/portal/intranet/appCenterUserSetup">{{ $t('appCenter.appLauncher.drawer.viewAll') }}</a>
            </v-card>
          </v-row>
        </v-navigation-drawer>
      </v-layout>
