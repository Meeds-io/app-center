    ...
    <template v-if="drawer" #content>
      <v-flex class="mx-0 drawerHeader flex-grow-0">
        <v-list-item class="ps-1 pe-5">
          ...
          <v-list-item-content v-if="filter" class="drawerTitle align-start text-header-title py-2">
          ...
          <div class="appLauncherList d-flex flex-wrap">
            <div
              ...
              <app-center-item
                ...
                @toogle-pin="$emit('toogle-pin', application, $event)" />
            </div>
          </div>
        </v-layout>
